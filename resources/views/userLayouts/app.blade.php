...
<body class="overflow-auto">
    <div>
        <nav class="navbar navbar-dark bg-dark navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="{{ route('articles') }}">{{ $site_information->name }}</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link text-decoration-none" href="{{ route('articles') }}">{{__('Home')}}</a>
                        </li>
                        <li class="nav-item">
...
<footer class="bg-dark text-center text-white footer">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © {{date('Y')}} Copyright:
        <a class="text-white text-decoration-none" href="{{ route('articles') }}">{{ $site_information->name }}</a>
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->
